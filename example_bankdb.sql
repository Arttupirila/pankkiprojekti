...
INSERT INTO `account` VALUES ('FI0445678900000084',1300.45,0.00,'6'),('FI2223456700000002',1100.95,0.00,'5'),('FI2223456700000102',900.35,0.00,'3'),('FI2445678900000104',2200.80,0.00,'4'),('FI4889012300000028',2800.30,0.00,'3'),('FI8334567800000063',900.30,0.00,'1'),('FI8445678900000064',2600.00,4500.00,'4'),('FI8990123400000069',2200.95,0.00,'2');
...
INSERT INTO `cardaccount` VALUES ('0600062009','FI0445678900000084'),('6319-7042-8350-1674','FI0445678900000084'),('0600062009','FI2223456700000002'),('9407-2685-3140-7592','FI2223456700000102'),('0500CB1EDE','FI2445678900000104'),('8201-6374-5908-1462','FI4889012300000028'),('0500CB1EDE','FI8445678900000064'),('0500CB1E52','FI8990123400000069');
...
BEGIN
  ...
  SET test1=ROW_COUNT();
    IF (test1 > 0) THEN
      COMMIT;
      INSERT INTO transaction(idAccount,dateAndTime,transactionType,transactionAmount) VALUES(first_id,NOW(),'Withdrawal',amount);
    ELSE
      ROLLBACK;
  END IF;
END ;;
...
BEGIN
  ...
  SET test2=ROW_COUNT();
    IF (test1 > 0 AND test2 >0) THEN
      COMMIT;
      INSERT INTO transaction(idAccount,dateAndTime,transactionType,transactionAmount,participantAccount) VALUES(first_id,NOW(),'Withdrawal',amount,second_id);
      INSERT INTO transaction(idAccount,dateAndTime,transactionType,transactionAmount,participantAccount) VALUES(second_id,NOW(),'Deposit',amount,first_id);
    ELSE
      ROLLBACK;
  END IF;
END ;;
...
-- Dump completed on 2024-04-10 13:59:24
